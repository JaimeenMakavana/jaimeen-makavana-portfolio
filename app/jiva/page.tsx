...
export default function JivaPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col items-center justify-center p-4 pb-28 md:pb-32 relative overflow-y-auto lg:overflow-hidden lg:pb-48">
